...
- `《网页基础》（精简版）.md`：网页教程核心教学内容，适合在 Markdown 编辑器（推荐 Typora）中阅读和演示。
- `typora-setup-x64-1.9.5.exe`：Typora 的安装程序（Windows x64）。
- `gen-typora-key_v1.0.1.exe`：与 Typora 的破解工具。
...
- 双击安装程序完成下载之后请勿打开Typora；
- 双击运行gen-typora-key_v1.0.1.exe破解工具，等待一会后复制出现的序列号；
...
1. 单机想要预览的文件即可实现在线预览
2. 受网页端影响可能会出现显示问题还是推荐Typora线下预览

## 2，使用相关网站进行查看

1. 打开浏览器在网址中输入https://www.mylyq.icu
2. 点击课程列表即可在线查看资料
3. 受技术影响，网页端跟新速度会慢于GitHub，如果想要最新资讯请关注本项目
